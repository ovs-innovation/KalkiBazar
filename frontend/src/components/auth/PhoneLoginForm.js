...
const PhoneLoginForm = ({ variant = "login" }) => {
  ...
  const primaryBtnClass =
    "flex w-full items-center justify-center gap-2 rounded-lg bg-store-600 py-3.5 text-base font-extrabold text-white shadow-[0_10px_22px_rgba(22,163,74,0.22)] transition hover:bg-store-700 active:translate-y-[1px] disabled:cursor-not-allowed disabled:opacity-55";
