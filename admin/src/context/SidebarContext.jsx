...
export const SidebarProvider = ({ children }) => {
  ...
  useEffect(() => {
    ...
    const cleanCompany = globalSetting?.company_name && globalSetting.company_name !== "Ayurvedha Aaushdi" && globalSetting.company_name !== "Farmacykart" && globalSetting.company_name.trim() !== ""
      ? globalSetting.company_name
      : "Kalki";
    document.title = cleanCompany + " - Admin";
  }, [globalSetting]);
